...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`fixed left-1/2 -translate-x-1/2 z-50 transition-all duration-300 w-[95%] md:w-[90%] py-3 px-6 rounded-[40px] border border-white/10 bg-white/5 backdrop-blur-md
      ${ scrolled? 'top-4 shadow-[0_8px_30px_rgba(0,0,0,0.3)]': 'top-4 bg-transparent border-transparent'
      }`}
    >
